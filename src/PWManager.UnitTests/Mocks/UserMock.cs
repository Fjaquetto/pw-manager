...
public static class UserMock
{
    ...
    public static List<User> GetUsers() => [new User
    {
        Id = Id1,
        Site = "github.com",
    ...
    public static User GetUserById(Guid id) => GetUsers().Find(u => u.Id == id) ?? throw new InvalidOperationException($"No mock user found with id {id}");
}
